<!--
  =====================================================
  通知面板浮层组件 NotificationPanel —— 相当于后端的消息中心弹窗
  =====================================================
  
  【核心概念】点击铃铛展开，显示通知列表，支持标记已读
  
  【后端类比】相当于后端的消息中心弹窗
  
  【Vue 组件核心概念（给后端开发者）】
    - props（:visible）—— 父组件控制面板是否显示，相当于后端的方法参数
    - emit（@close）—— 关闭面板事件，相当于后端的回调函数
    - Pinia Store —— 通知状态管理，相当于后端的 Redis 缓存
-->
<template>

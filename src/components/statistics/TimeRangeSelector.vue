<!--
  =====================================================
  时间范围选择器组件 TimeRangeSelector —— 相当于后端的日期范围选择器
  =====================================================
  
  【核心概念】选择统计的时间范围（今日/本周/本月/自定义）
  
  【后端类比】相当于后端的日期范围选择器，类似日期筛选条件
  
  【Vue 组件核心概念（给后端开发者）】
    - v-model（modelValue）—— 双向绑定选中的时间范围，相当于后端的表单字段绑定
    - emit（@update:modelValue）—— 时间范围变化事件，相当于后端的回调函数
-->
<template>
